...
import { TrendingUp, TrendingDown, Users, Eye, Clock, ArrowUpRight, ArrowDownRight, Calendar, BarChart3, FileText } from 'lucide-react';
...
export default function BitfinanzasReport() {
  ...
  const monthlyData2025 = [
    { mes: 'Septiembre', usuarios: 52384, nuevos: 37768, pageviews: 128495, sesiones: 99613, duracion: 118.8, bounce: 46.08 },
    { mes: 'Octubre', usuarios: 144914, nuevos: 122443, pageviews: 312693, sesiones: 259214, duracion: 94.4, bounce: 45.93 },
    { mes: 'Noviembre', usuarios: 182693, nuevos: 149651, pageviews: 362462, sesiones: 301836, duracion: 91.4, bounce: 46.03 },
    { mes: 'Diciembre*', usuarios: 84704, nuevos: 61249, pageviews: 171927, sesiones: 143294, duracion: 90.8, bounce: 47.45 }
  ];
  ...
  const weeklyData = [
    ...
    { semana: 'Sem 41 (Oct 6-12)', usuarios: 41224, pageviews: 67297, bounce: 46.10 },
    ...
    { semana: 'Sem 51 (Dic 15-21)', usuarios: 21838, pageviews: 38352, bounce: 49.70 },
    ...
    <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
      <div className="flex items-start justify-between">
        ...
        <div className={`p-2 rounded-lg ${change ? (change.positive ? 'bg-green-50' : 'bg-red-50') : 'bg-blue-50'}`}>
          <Icon className={`w-5 h-5 ${change ? (change.positive ? 'text-green-600' : 'text-red-600') : 'text-blue-600'}`} />
        </div>
      </div>
      {change && (
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <MetricCard
              ...
              value={847082}
              icon={BarChart3}
              subtitle="Page views acumulados"
            />
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm">
            ...
            <ResponsiveContainer width="100%" height={300}>
              <ComposedChart data={monthlyData2025}>
                ...
                <Line type="monotone" dataKey="sesiones" name="Sesiones" stroke="#F59E0B" strokeWidth={3} dot={{ r: 5 }} />
              </ComposedChart>
            </ResponsiveContainer>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm">
            ...
            <div className="mt-4 p-4 bg-blue-50 rounded-lg">
              <p className="text-sm text-blue-800">
                ...
                lo que indica una base de lectores fieles. Sin embargo, el volumen total ha disminuido significativamente respecto a 2024.
              </p>
            </div>
          </div>
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-xl p-6 shadow-sm">
            ...
            <ResponsiveContainer width="100%" height={400}>
              <AreaChart data={weeklyData}>
                ...
                <YAxis tickFormatter={(v) => `${(v/1000).toFixed(0)}K`} tick={{ fontSize: 12 }} />
                <Tooltip formatter={(v) => formatNumber(v)} />
                <Area type="monotone" dataKey="usuarios" stroke="#3B82F6" fillOpacity={1} fill="url(#colorWeekly)" strokeWidth={2} />
              </AreaChart>
            </ResponsiveContainer>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-green-50 border border-green-200 rounded-xl p-4">
              ...
              <ul className="text-green-700 text-sm space-y-1">
                <li><strong>Semana 47 (Nov 17-23):</strong> 64,874 usuarios</li>
                <li><strong>Semana 45 (Nov 3-9):</strong> 61,480 usuarios</li>
                <li><strong>Semana 42 (Oct 13-19):</strong> 61,278 usuarios</li>
              </ul>
            </div>
            <div className="bg-red-50 border border-red-200 rounded-xl p-4">
              <h4 className="font-semibold text-red-800 mb-2">📉 Semanas Más Bajas</h4>
              <ul className="text-red-700 text-sm space-y-1">
                <li><strong>Semana 52 (Dic 22-23):</strong> 3,125 usuarios (parcial)</li>
                <li><strong>Semana 51 (Dic 15-21):</strong> 21,838 usuarios</li>
                <li><strong>Semana 43 (Oct 20-26):</strong> 23,381 usuarios</li>
              </ul>
            </div>
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
            ...
            <ul className="text-blue-700 text-sm space-y-2">
              <li>• <strong>Acciones con potencial:</strong> Los artículos sobre recomendaciones de bancos (Goldman, Citi, JPMorgan) generan alto tráfico</li>
              <li>• <strong>Cripto:</strong> Contenido sobre Bitcoin, Cathie Wood y líderes de opinión sigue atrayendo audiencia</li>
              <li>• <strong>Kiyosaki:</strong> Continúa siendo un imán de tráfico constante</li>
              <li>• <strong>Oportunidad:</strong> El contenido sobre predicciones y "acciones para invertir" tiene muy buen rendimiento</li>
            </ul>
          </div>
        </div>
      )}
      ...
      {activeTab === 'yoy' && (
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm">
            ...
            <p className="text-xs text-gray-500 mt-3">*Diciembre 2025: datos hasta el 23. Diciembre 2024: datos hasta el 23 para comparación justa.</p>
          </div>
